...
if __name__ == "__main__":
    # Training parameters
    parser = argparse.ArgumentParser(description='MNIST with SGP')
    ...
    parser.add_argument('--gpm_thro', type=float, default=0.95,
                        metavar='gradient projection', help='gpm_thro')
    ...
    parser.add_argument('--savename', type=str, default='./log/DFSGP/',
                        help='save path')
    ...
    for mixup_weight in [0.01, 0.001, 0.0001]:
        ...
        for thro_ in [0.93, 0.94, 0.95, 0.96, 0.97, 0.98, 0.99]:
            args.gpm_thro = thro_
            str_time = str_time_ + '_' + str(thro_) + '_0.99_0.99_mixup' + str(mixup_weight)
